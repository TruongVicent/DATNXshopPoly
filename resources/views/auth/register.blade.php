        ...
        <div class="row">
            <div class="col-12">
                <div class="mb-5">
                    ...
                    <p class="text-center m-0">Bạn đã có tài khoản? <a href="{{ route('login') }}">Đăng Nhập</a></p>
                </div>
            </div>
        </div>
                            ...
                            <div class="row gy-3 overflow-hidden">
                                <div class="col-12">
                                    <div class="form-floating mb-3">
                                        <input type="name" class="form-control border-2 border-bottom rounded-0"
                                               name="name" id="name" placeholder="Họ Tên">
                                        <label for="name" class="form-label">Họ Tên</label>
                                        @if($errors->any('name'))
                                            <div id="name" class="form-text text-danger">{{ $errors->first('name') }}.
                                            </div>
                                        @endif
                                    </div>
                                </div>
                        ...
                        <div class="d-flex gap-3 flex-column w-100 ">
                            ...
                            <a href="#!"
                               class="btn bsb-btn-2xl btn-outline-dark rounded-0 d-flex align-items-center">
                                ...
                                <span class="ms-2 fs-6 flex-grow-1">Đăng nhập Facebook</span>
                            </a>
                        </div>
                    </div>
                </div>
