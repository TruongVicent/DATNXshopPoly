...
use App\Filament\App\Resources\VoucherTypeResource\Pages;
use App\Filament\App\Resources\VoucherTypeResource\RelationManagers;
...
class VoucherTypeResource extends Resource
{
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewVoucherType::route('/{record}'),
